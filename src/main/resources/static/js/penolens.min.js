(function (k, d) {
  "object" === typeof exports && "undefined" !== typeof module
    ? d(exports, require("three"))
    : "function" === typeof define && define.amd
    ? define(["exports", "three"], d)
    : ((k = k || self), d((k.PANOLENS = {}), k.THREE));
})(this, function (k, d) {
  function Y(a) {
  ...
  function y(a, b, c) {
    ...
    c = function (b) {
      if (this.material) {
        ...
        c.copy(this.scale);
        this.scaleUpAnimation = new m.Tween(this.scale)
          .to({ x: 1.3 * c.x, y: 1.3 * c.y }, 500)
          .easing(m.Easing.Elastic.Out);
        this.scaleDownAnimation = new m.Tween(this.scale)
          .to({ x: c.x, y: c.y }, 500)
          .easing(m.Easing.Elastic.Out);
        this.material.map = b;
    ...
    this.showAnimation = new m.Tween(this.material)
      .to({ opacity: 1 }, 500)
      .onStart(this.enableRaycast.bind(this, !0))
      .easing(m.Easing.Quartic.Out);
    this.hideAnimation = new m.Tween(this.material)
      .to({ opacity: 0 }, 500)
  ...
  function r() {
    ...
    this.renderOrder = -1;
    this.active = !1;
    this.infospotAnimation = new m.Tween(this).to(
      {},
  ...
  function ca(a, b) {
    ...
    this.pan = function (a, b) {
      ...
      if (f.object instanceof d.PerspectiveCamera) {
        ...
        f.object instanceof d.OrthographicCamera
          ? (f.panLeft((a * (f.object.right - f.object.left)) / e.clientWidth),
            f.panUp((b * (f.object.top - f.object.bottom)) / e.clientHeight))
          : console.warn(
    ...
    this.momentum = function () {
      U &&
        (1e-4 > Math.abs(O) && 1e-4 > Math.abs(P)
          ? (U = !1)
          : ((P *= this.momentumDampingFactor),
    ...
    this.update = function (a) {
      if (!1 !== c.enabled && c.deviceOrientation) {
        var b = c.deviceOrientation.alpha
            ? d.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle
            : 0,
          h = c.deviceOrientation.beta
            ? d.Math.degToRad(c.deviceOrientation.beta)
            : 0,
          f = c.deviceOrientation.gamma
            ? d.Math.degToRad(c.deviceOrientation.gamma)
            : 0,
        ...
        if (0 == c.screenOrientation) {
          ...
          180 == c.screenOrientation
            ? ((q = new d.Vector3(1, 0, 0)), m.setFromAxisAngle(q, g))
            : 90 == c.screenOrientation
            ? ((q = new d.Vector3(0, 1, 0)), m.setFromAxisAngle(q, g))
            : -90 == c.screenOrientation &&
              ((q = new d.Vector3(0, 1, 0)), m.setFromAxisAngle(q, -g));
        k.multiply(m);
        k.multiply(r);
  ...
  function ia(a) {
    ...
    var h = new d.Vector2(0.441, 0.156),
      p = new d.PlaneBufferGeometry(1, 1, 10, 20)
  ...
  var ja = "^0.105.2".replace(/[^0-9.]/g, ""),
    ...
    fa = {
      load: function (a, b, c, e) {
        ...
        if (0 === a.indexOf("data:"))
          return m.addEventListener("load", f, !1), (m.src = a), m;
        ...
        g.addEventListener("loadend", function (a) {
          a &&
            ((h = new Uint8Array(a.currentTarget.response)),
            (p = new window.Blob([h])),
        ...
        a.map(function (a, d) {
          fa.load(
            ...
            function (a) {
              ...
              g = l.total = 0;
              for (var b in n)
                g++, (l.loaded += n[b].loaded), (l.total += n[b].total);
  ...
  J.prototype = Object.assign(Object.create(d.Sprite.prototype), {
    ...
    updateCanvasArcByProgress: function (a) {
      ...
      b.beginPath();
      0 === a
        ? (b.arc(l, h, c / 16, 0, 2 * Math.PI), (b.fillStyle = n), b.fill())
        : (b.arc(l, h, c / 4 - 3, -Math.PI / 2, -Math.PI / 2 + d),
          (b.strokeStyle = n),
          (b.lineWidth = 3),
          b.stroke());
      b.closePath();
  ...
  var m = (function (a, b) {
      ...
      update: function (a, b) {
        ...
        for (a = void 0 !== a ? a : c.now(); 0 < e.length; ) {
          ...
          for (var g = 0; g < e.length; g++) {
            ...
            d &&
              !1 === d.update(a) &&
              ((d._isPlaying = !1), b || delete this._tweens[e[g]]);
          }
    ...
    c.Interpolation = {
      ...
      CatmullRom: function (a, b) {
        ...
        return a[0] === a[e]
          ? (0 > b && (d = Math.floor((g = e * (1 + b)))),
            l(a[(d - 1 + e) % e], a[d], a[(d + 1) % e], a[(d + 2) % e], g - d))
          : 0 > b
          ? a[0] - (l(a[0], a[0], a[1], a[1], -g) - a[0])
          : 1 < b
          ? a[e] - (l(a[e], a[e], a[e - 1], a[e - 1], g - e) - a[e])
          : l(
              a[d ? d - 1 : 0],
              a[d],
              a[e < d + 1 ? e : d + 1],
  ...
  y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
    ...
    onHoverStart: function (a) {
      if (this.getContainer()) {
        var b =
            this.cursorStyle ||
            (this.mode === q.NORMAL ? "pointer" : "default"),
        ...
        g &&
          ...
          (b = g.right),
          (c = g.style),
          this.mode === q.CARDBOARD || this.mode === q.STEREO
            ? ((c.display = "none"),
    ...
    translateElement: function (a, b) {
      if (this.element._width && this.element._height && this.getContainer()) {
        ...
        (a === c.clientWidth / 2 && b === c.clientHeight / 2)
          ...
          : ((n = c.clientWidth / 4 - g + (a - c.clientWidth / 2)),
    ...
    show: function (a) {
      ...
      this.animated
        ...
        : (this.enableRaycast(!0), (e.opacity = 1));
    },
    hide: function (a) {
      a = void 0 === a ? 0 : a;
      var b = this.hideAnimation,
      ...
      this.animated
        ...
        : (this.enableRaycast(!1), (e.opacity = 0));
    },
    ...
    createVideoControlButton: function () {
      ...
      b.update = function (a) {
        ...
        this.style.backgroundImage =
          'url("' + (this.paused ? t.VideoPlay : t.VideoPause) + '")';
      };
      return b;
    },
  ...
  r.prototype = Object.assign(Object.create(d.Mesh.prototype), {
    ...
    setupTransitions: function () {
      ...
      this.fadeOutAnimation = new m.Tween(this.material)
        .easing(m.Easing.Quartic.Out)
        .onComplete(
          function () {
            this.visible = !1;
    ...
    dispose: function () {
      function a(b) {
        for (
          var c = b.geometry, d = b.material, h = b.children.length - 1;
          0 <= h;
          h--
        )
          a(b.children[h]), b.remove(b.children[h]);
      ...
      b &&
        b.uniforms &&
        b.uniforms.tEquirect &&
        b.uniforms.tEquirect.value.dispose();
  ...
  z.prototype = Object.assign(Object.create(r.prototype), {
    ...
    load: function () {
      ...
      2 < h.readyState
        ? d.call(this)
        : (0 === h.querySelectorAll("source").length &&
  ...
  Object.assign(Z.prototype, {
    ...
    composeFromTile: function (a, b, c) {
      ...
      var h = Math.floor(a / e),
        k = Math.floor(b / d);
      this._ctx[k * this._wc + h].drawImage(
        c,
        0,
        0,
        c.width,
    ...
    composePanorama: function () {
      ...
      for (var e = this._parameters.useWebGL, d = 0; d < b; d++)
        for (
          var h = {}, k = 0;
          k < a;
          h = { $jscomp$loop$prop$url$2: h.$jscomp$loop$prop$url$2 }, k++
        )
          (h.$jscomp$loop$prop$url$2 =
  ...
  N.prototype = Object.assign(Object.create(u.prototype), {
    ...
    onLoad: function (a) {
      ...
      this.stereo.updateUniformByFormat(
        4 === b.width / b.height ? C.SBS : C.TAB,
  ...
  G.prototype = Object.assign(Object.create(z.prototype), {
    ...
    onLoad: function (a) {
      var b = a.image;
      this.stereo.updateUniformByFormat(
        4 === b.videoWidth / b.videoHeight ? C.SBS : C.TAB,
        this.material.uniforms
      );
      this.material.uniforms.tEquirect.value = a;
  ...
  ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
    ...
    calculateCameraDirectionDelta: function (a) {
      ...
      var c = b.clone();
      var e = this.panorama
        .getWorldPosition(new d.Vector3())
        .sub(this.camera.getWorldPosition(new d.Vector3()));
      a = a.clone();
      a.add(e).normalize();
      var g = a.clone();
      b.y = 0;
      ...
      e = e < -Math.PI ? e + 2 * Math.PI : e;
      b = Math.abs(
        c.angleTo(b) + (0 >= c.y * g.y ? g.angleTo(a) : -g.angleTo(a))
      );
      b *= g.y < c.y ? 1 : -1;
      return { left: e, up: b };
    },
    ...
    onWindowResize: function (a, b) {
      ...
      this.scene.traverse(function (a) {
        a.dispatchEvent &&
          a.dispatchEvent({ type: "window-resize", width: e, height: d });
      });
    },
