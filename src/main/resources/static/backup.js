...
//     //   data[0] + " " + cname,
//     //   data[1] + " " + accNum,
//     //   data[2] + " " + loanamout + data[14],
//     //   data[3] + " " + pendingamount + data[14],
//     //   data[4] + " " + EMIamount + data[14],
//     //   data[5] + " " + duedate,
//     //   data[6] + " " + pemi + data[14],
//     //   data[7] + "" + cinstatus,
//     //   data[8] + "" + Lastpaiddate,
...
//     //   data[11] + "" + Outstanding + data[14],
//     //   data[12] + "" + Preclosureamt + data[14],
...
//           try {
//             await playAudioPromise(text); // Assuming playAudioPromise is correctly defined elsewhere
//           } catch (error) {
//             console.error("Error playing audio:", error);
//           }
//         }
...
//         // Splitting text2 into lines and processing them
//         const text2Lines = text2.split(".");
//         for (let i = 0; i < text2Lines.length; i++) {
//           const line = text2Lines[i].trim();
//           if (!line) continue;

//           const text2Element = document.createElement("p");
//           text2Element.textContent = line;
//           textContainer.appendChild(text2Element);

//           // Add a delay between lines if needed
//           await new Promise((resolve) => setTimeout(resolve, 1000)); // Adjusted delay to a more reasonable duration
...
//           // Adapt your playAudio function to call resolve() when audio ends
//           playAudio(text, resolve);
//         });
//       }

//       await processNextSentence(); // Kick off the process
//     }

//     // Start displaying sentences, beginning with index 0
//     displaySentences(0);

//     // Initialize the index to keep track of the current message
//   });
// }
