...
@CrossOrigin(origins = "https://websitetometa.blob.core.windows.net/staticwebsite/index.html")
@RestController
public class CallToMeta {
	...
	@RequestMapping(value={"/meta"}, method = RequestMethod.POST)
	  public  ResponseEntity<GeneralResponse>  callTometa(@RequestBody MetaPayload metaPayload,HttpServletResponse response )
		    ...
		    response.setHeader("Access-Control-Allow-Origin", "https://websitetometa.blob.core.windows.net/staticwebsite/index.html");
